...
.gMhSYS.vertical-list, .gMhSYS.swiper-slide {
    width: 198.75px;
    height: 111.75px;
}

.gMhSYS.vertical-list .info-footer-container, .gMhSYS.swiper-slide .info-footer-container {
    height: 42px;
    bottom: 4px;
}

.gMhSYS.vertical-list .content-type-icon, .gMhSYS.swiper-slide .content-type-icon {
    right: 0.5em;
    bottom: calc( 42px + 0.5em);
}

.gMhSYS.vertical-list .content-type-icon-prod, .gMhSYS.swiper-slide .content-type-icon-prod {
    right: 0.5em;
...
.hXUrXc.vertical-list, .hXUrXc.swiper-slide {
    width: 247.99999999999997px;
    height: 145.2px;
}

.hXUrXc.vertical-list .info-footer-container, .hXUrXc.swiper-slide .info-footer-container {
    height: 0px;
    bottom: 4px;
}

.hXUrXc.vertical-list .content-type-icon, .hXUrXc.swiper-slide .content-type-icon {
    right: 0.5em;
    bottom: calc( 0px + 0.5em);
}

.hXUrXc.vertical-list .content-type-icon-prod, .hXUrXc.swiper-slide .content-type-icon-prod {
    right: 0.5em;
...
.bHOexk.vertical-list, .bHOexk.swiper-slide {
    width: 198.75px;
    height: 299.25px;
}

.bHOexk.vertical-list .info-footer-container, .bHOexk.swiper-slide .info-footer-container {
    height: 0px;
    bottom: 4px;
}

.bHOexk.vertical-list .content-type-icon, .bHOexk.swiper-slide .content-type-icon {
    right: 0.5em;
    bottom: calc( 0px + 0.5em);
}

.bHOexk.vertical-list .content-type-icon-prod, .bHOexk.swiper-slide .content-type-icon-prod {
    right: 0.5em;
    bottom: calc( 0px + -2.5em);
}
...
.cEQdAK.vertical-list, .cEQdAK.swiper-slide {
    width: 198.75px;
    height: 299.25px;
}

.cEQdAK.vertical-list .info-footer-container, .cEQdAK.swiper-slide .info-footer-container {
    height: 0px;
    bottom: 4px;
}

.cEQdAK.vertical-list .content-type-icon, .cEQdAK.swiper-slide .content-type-icon {
    right: 0.5em;
    bottom: calc( 0px + 0.5em);
}

.cEQdAK.vertical-list .content-type-icon-prod, .cEQdAK.swiper-slide .content-type-icon-prod {
    right: 0.5em;
    bottom: calc( 0px + -2.5em);
}
...
.fUSwjr {
    ...
    background: radial-gradient(circle at center 43%, rgba(76, 134, 193, 0.85) 0%, rgba(0, 0, 0, .9) 60%, rgba(0, 0, 0, 1) 100%);
}
...
.fjVPlx .link:active, .fjVPlx .link:visited {
    -webkit-text-decoration: none;
    text-decoration: none;
    color: #ffffff;
}
...
.hHOFJM .swiper-container .swiper-button-next, .hHOFJM .swiper-container .swiper-button-prev {
    background: none;
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
...
.hHOFJM .swiper-container .swiper-button-next.swiper-button-disabled, .hHOFJM .swiper-container .swiper-button-prev.swiper-button-disabled {
    opacity: 0;
}
...
.fqiqOX .swiper-container .swiper-button-next, .fqiqOX .swiper-container .swiper-button-prev {
    background: none;
    display: -webkit-box;
    display: -webkit-flex;
    display: -ms-flexbox;
...
.fqiqOX .swiper-container .swiper-button-next.swiper-button-disabled, .fqiqOX .swiper-container .swiper-button-prev.swiper-button-disabled {
    opacity: 0;
}
...
.XMroH .swiper-button-prev:before, .XMroH .swiper-button-next:before {
    content: "";
    position: absolute;
    display: block;
    width: 2.5em;
...
.XMroH .swiper-button-prev svg, .XMroH .swiper-button-next svg {
    display: none;
}
...
.fNqDmr .swiper-container .swiper-button-next, .fNqDmr .swiper-container .swiper-button-prev {
    display: none;
}
...
.fNqDmr.swipersliderkids .swiper-container .swiper-button-next, .fNqDmr.swipersliderkids .swiper-container .swiper-button-prev {
    display: block;
    opacity: unset;
    bottom: 220px;
    top: unset;
...
.gUbmjw .user-icon, .gUbmjw .input-search {
    margin-right: 20px;
...
.cmruew {
    ...
    margin-bottom: 100px;
    margin-top: -135px;
    background: -moz-linear-gradient( top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.01) 1%, rgba(0, 0, 0, 0.98) 72%, rgba(0, 0, 0, 0.98) 99%);
    background: -webkit-linear-gradient( top, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.01) 1%, rgba(0, 0, 0, 0.98) 72%, rgba(0, 0, 0, 0.98) 99%);
    background: linear-gradient( to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.01) 1%, rgba(0, 0, 0, 0.98) 72%, rgba(0, 0, 0, 0.98) 99%);
