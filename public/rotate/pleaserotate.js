(function () {
    ...
    var options = {
        ...
        onShow: function () {},
        forcePortrait: false,
        message: "Para disfrutar mejor de la experiencia te invitamos a girar tu celular",
    ...
    var cssRules = [
        ...
        "#pleaserotate-backdrop { background-color: black; top: 0; left: 0; position: fixed; width: 100%; height: 100%; }",
        "#pleaserotate-container { text-align: center; width: 80%; position: absolute; top: 50%; left: 50%; margin-right: -50%; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%); }",
        "#pleaserotate-message { color: white; margin-top: 20px; font-size: 12px; text-align: center; font-family: Verdana, Geneva, sans-serif; text-transform: uppercase }",
