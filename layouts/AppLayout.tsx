      ...
      <header className="OrHeader__Header-sc-1x6b4le-0 flrEJC">
        <div className="resizecontainer OrHeader__Menu-sc-1x6b4le-2 gJJULp">
          <a className="logo AtLogo__LogoLink-si2gse-0 eFdoju" href="https://www.rtvcplay.co/">
            <img className="logo AtImg__Img-sc-31cwo7-0 gYLCMU" src="img/logo-RTVCPlay-Header.png" alt="RTVCPlay" />
          </a>
          <nav className="OrHeader__Navbar-sc-1x6b4le-3 kAVABN MolNavbar__Navbar-sc-1ovhdmy-0 kHHSCX">
            <div>
              <a title="Ficción" data-submenu="sub-ficcion" className="has-submenu MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">Ficción</a>
            </div>
            <div>
              <a title="Documentales" data-submenu="sub-documental" className="has-submenu MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">Documentales</a>
            </div>
            <div>
              <a title="Podcasts" data-submenu="sub-podcast" className="has-submenu MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">Podcasts</a>
            </div>
            <div>
              <a title="Especiales" data-submenu="sub-especial" className="has-submenu MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">Especiales</a>
            </div>
            <div>
              <a title="En vivo" data-submenu="sub-vivo" className="has-submenu MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">
                <span className="AtTextLink__IconLeft-sc-1mrxibb-1 IHUBP">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 17" width="18" height="18" focusable="false" aria-hidden="true" className="AtIcon__StyledIcon-boprg-0 iswYYK Icons__SvgIcon-sc-10bknwo-0 iomDSz"
                    fill="none">
                    <image id="image0" width="17" height="17" x="0" y="0" href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAARCAMAAAAMs7fIAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
LTE0VDA0OjQ2OjI0KzAzOjAwzJSPrgAAACV0RVh0ZGF0ZTptb2RpZnkAMjAyMC0wNy0xNFQwNDo0
        NjoyNCswMzowML3JNxIAAAAASUVORK5CYII="></image>
                            </svg>
                        </span>En vivo</a>
                </div>
          <div>
            <a id="link-ninos" href="https://www.rtvcplay.co/ninos" title="INFANTIL" className="MolNavbar__NavbarButton-sc-1ovhdmy-1 gkLvNN AtTextLink__Link-sc-1mrxibb-0 iMBqoc">
              <span className="AtTextLink__IconLeft-sc-1mrxibb-1 IHUBP">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 82 40" width="40" height="18" focusable="false" aria-hidden="true" color="#009bdb"
      ...
      <div className="OrHeader__ButtonIconGroup-sc-1x6b4le-5 gUbmjw">
        <div className="input-search MolInputSearch__Container-sc-1ph5lrp-0 gKTUqY">
          <form>
            <button color="rgba(0,0,0,0)" className="iconsearch AtIconButton__Button-kz6x7x-0 IVHCz" type="submit">
              <svg viewBox="0 0 512 512" height="22" width="22" aria-hidden="true" focusable="false" fill="currentColor" id="Iconsearch"
                size="22" color="#ffffff" className="AtIcon__StyledIcon-boprg-0 gLoOCx">
            ...
            <div className="AtSearchFocus__ContentSearch-sc-1yudiy5-1 cgABmB">
              <div>
                <div id="cover-search" className="hidden" style="position: fixed; top: 0px; left: 0px; width: 100%; height: 100%; justify-content: center; align-items: center; z-index: 10000;">
                  <div style="border-radius: 5px; box-sizing: border-box; box-shadow: rgba(0, 0, 0, 0.3) 0px 2px 4px; transform: translate3d(0px, 0px, 0px); transition: transform 500ms cubic-bezier(0, 0, 0.25, 1) 0s, opacity 500ms cubic-bezier(0, 0, 0.25, 1) 0s; z-index: 10002;">
                    <div className="AtSearchFocus__ContentCloseModal AtSearchFocus__ContentCloseModal-sc-1yudiy5-5 iiukhQ">Cerrar
                                            <button color="rgba(0,0,0,0)" className="AtSearchFocus__AtIconButtonCloseModal AtSearchFocus__AtIconButtonCloseModal-sc-1yudiy5-4 kLQqdk AtIconButton__Button-kz6x7x-0 IVHCz"
                        type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="52" height="52" aria-hidden="true" color="#ffffff" className="AtIcon__StyledIcon-boprg-0 gDvSIs Icons__SvgIcon-sc-10bknwo-0 gIkEiP">
                    ...
                    <form>
                      <button color="rgba(0,0,0,0)" className="AtSearchFocus__AtIconButtonSearchclose AtSearchFocus__AtIconButtonSearchclose-sc-1yudiy5-3 bBWseP AtIconButton__Button-kz6x7x-0 IVHCz"
                        type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 35" width="32" height="32" aria-hidden="true" color="#121212" className="AtIcon__StyledIcon-boprg-0 gDvSIs Icons__SvgIcon-sc-10bknwo-0 jaEYJn">
                          <path transform="translate(-1122 -458)" className="cls-1" d="M1139.5,493a17.444,17.444,0,0,1-6.4-1.2,1.166,1.166,0,1,1,.85-2.171,15.176,15.176,0,0,0,16.48-24.649,1.166,1.166,0,1,1,1.68-1.617A17.506,17.506,0,0,1,1139.5,493Zm-8.84-2.592a1.136,1.136,0,0,1-.63-0.186c-0.21-.134-0.41-0.272-0.61-0.414a1.164,1.164,0,0,1,1.34-1.9c0.18,0.124.36,0.243,0.53,0.359A1.164,1.164,0,0,1,1130.66,490.409Zm-3.11-2.6a1.161,1.161,0,0,1-.85-0.371,17.506,17.506,0,0,1,12.8-29.452,1.166,1.166,0,0,1,0,2.332,15.176,15.176,0,0,0-11.1,25.529A1.163,1.163,0,0,1,1127.55,487.811Zm20.33-25.176a1.177,1.177,0,0,1-.6-0.165,15.183,15.183,0,0,0-2.81-1.318,16.419,16.419,0,0,0-1.7-.478,1.164,1.164,0,0,1-.89-1.388,1.179,1.179,0,0,1,1.39-.889,17.332,17.332,0,0,1,5.21,2.073,1.159,1.159,0,0,1,.4,1.6A1.147,1.147,0,0,1,1147.88,462.635Zm-6.47,13.436-1.34,1.335,6.24,6.237a0.945,0.945,0,1,0,1.34-1.333Zm6.24-8.725a0.951,0.951,0,0,0-1.34,0l-6.81,6.816-6.82-6.816a0.942,0.942,0,1,0-1.33,1.335l6.81,6.814-6.81,6.815a0.939,0.939,0,0,0,0,1.333,0.934,0.934,0,0,0,1.33,0l14.97-14.962A0.96,0.96,0,0,0,1147.65,467.346Z"></path>
                        </svg>
                      </button>
                      <input id="inputsearch" type="text" name="buscar" placeholder=" Escribe tu búsqueda" autofocus="true" className="AtSearchFocus__Input-sc-1yudiy5-0 dkdikb"
                        value="" />
                      <button color="rgba(0,0,0,0)" className="AtSearchFocus__AtIconButtonSearch AtSearchFocus__AtIconButtonSearch-sc-1yudiy5-2 gUfhCd AtIconButton__Button-kz6x7x-0 IVHCz"
                        type="submit">
                        <svg viewBox="0 0 512 512" height="32" width="32" aria-hidden="true" focusable="false" fill="currentColor" id="Iconsearch"
                          size="32" color="#ffffff" className="AtIcon__StyledIcon-boprg-0 gLoOCx">
                          <path fill="currentColor" d="M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z"></path>
                        </svg>
                      </button>
                    </form>
                  </div>
                  <div style="position: fixed; top: 0px; left: 0px; width: 100%; height: 100%; background-color: rgba(0, 0, 0, 0.7); z-index: 10001;"></div>
                </div>
              </div>
            </div>
          </form>
        </div>
        <button id="menu-mobile-button" color="rgba(0,0,0,0)" className="bars-icon OrHeader__BarsIconButton-sc-1x6b4le-9 bceAaI AtIconButton__Button-kz6x7x-0 IVHCz"
          type="button">
          <svg viewBox="0 0 448 512" height="22" width="22" aria-hidden="true" focusable="false" fill="currentColor" id="IconBars"
            size="22" color="#ffffff" className="AtIcon__StyledIcon-boprg-0 gLoOCx">
    ...
    <div className="submenu-container OrHeader__SubMenu-sc-1x6b4le-6 jgKeYC">
      <div id="sub-ficcion" className="submenu OrHeader__MenuCOD-sc-1x6b4le-7 bQHbPU MolMenuCOD__Container-sc-16jdr3r-0 yznpj">
        <div className="submenu-items MolMenuCOD__MenuBlock-sc-16jdr3r-1 kFvGBO">
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/series-ficcion" title="Series" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Series</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/peliculas-ficcion" title="Películas" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Películas</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/cortometrajes-ficcion" title="Cortometrajes" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Cortometrajes</a>
          </div>
        </div>
        <div className="MolMenuCOD__ContentBlock-sc-16jdr3r-4 hABRnM"></div>
      </div>
      <div id="sub-documental" className="submenu OrHeader__MenuCOD-sc-1x6b4le-7 bQHbPU MolMenuCOD__Container-sc-16jdr3r-0 yznpj">
        <div className="submenu-items MolMenuCOD__MenuBlock-sc-16jdr3r-1 kFvGBO">
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/series-documentales" title="Series" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Series</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/peliculas-documentales" title="Películas" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Películas</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/cortometrajes-documentales" title="Cortometrajes" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Cortometrajes</a>
          </div>
        </div>
        <div className="MolMenuCOD__ContentBlock-sc-16jdr3r-4 hABRnM"></div>
      </div>
      <div id="sub-podcast" className="submenu OrHeader__MenuCOD-sc-1x6b4le-7 bQHbPU MolMenuCOD__Container-sc-16jdr3r-0 yznpj">
        <div className="submenu-items MolMenuCOD__MenuBlock-sc-16jdr3r-1 kFvGBO">
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/series-podcasts" title="Series" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Series</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/radionovelas-podcasts" title="Radionovelas" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Radionovelas</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/entrevistas-podcasts" title="Entrevistas" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Entrevistas</a>
          </div>
        </div>
        <div className="MolMenuCOD__ContentBlock-sc-16jdr3r-4 hABRnM"></div>
      </div>
      <div id="sub-especial" className="submenu OrHeader__MenuCOD-sc-1x6b4le-7 bQHbPU MolMenuCOD__Container-sc-16jdr3r-0 yznpj">
        <div className="submenu-items MolMenuCOD__MenuBlock-sc-16jdr3r-1 kFvGBO">
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/educacion" title="Educación" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Educación</a>
          </div>
          <div className="MolMenuCOD__Menu-sc-16jdr3r-2 gIdhsh">
            <a href="https://www.rtvcplay.co/inventos" title="Inventos" className="MolMenuCOD__MenuItem-sc-16jdr3r-3 dSsyKF AtTextLink__Link-sc-1mrxibb-0 jalbS">Inventos</a>
          </div>
        </div>
        <div className="MolMenuCOD__ContentBlock-sc-16jdr3r-4 hABRnM"></div>
      </div>
      <div id="sub-vivo" className="submenu OrHeader__MenuLS-sc-1x6b4le-8 hyLmch MolMenuLS__Container-sc-1mj2srx-0 eTRRwO">
        <a href="https://www.rtvcplay.co/en-vivo/canal-institucional" target="" className="MolMenuLS__ImgLink-sc-1mj2srx-1 dwhsWo AtImgLink__ImgLink-sc-1ji04qf-0 fegtQU"
          opacity="0.8">
          <img className="AtImg__Img-sc-31cwo7-0 gYLCMU" src="img/logo-canal-institucional_0.png" alt="Canal Institucional" />
        </a>
        <a href="https://www.rtvcplay.co/en-vivo/radio-nacional" target="" className="MolMenuLS__ImgLink-sc-1mj2srx-1 dwhsWo AtImgLink__ImgLink-sc-1ji04qf-0 fegtQU"
          opacity="0.8">
          <img className="AtImg__Img-sc-31cwo7-0 gYLCMU" src="img/logo-radio-nacional.png" alt="Radio Nacional" />
        </a>
        <a href="https://www.rtvcplay.co/en-vivo/radionica" target="" className="MolMenuLS__ImgLink-sc-1mj2srx-1 dwhsWo AtImgLink__ImgLink-sc-1ji04qf-0 fegtQU"
          opacity="0.8">
          <img className="AtImg__Img-sc-31cwo7-0 gYLCMU" src="img/logo-radionica.png" alt="Radiónica" />
        </a>
        <a href="https://www.rtvcplay.co/en-vivo/senal-colombia" target="" className="MolMenuLS__ImgLink-sc-1mj2srx-1 dwhsWo AtImgLink__ImgLink-sc-1ji04qf-0 fegtQU"
          opacity="0.8">
          <img className="AtImg__Img-sc-31cwo7-0 gYLCMU" src="img/logo-senal-colombia.png" alt="Señal Colombia" />
        </a>
      </div>
    </div>
    </header >
